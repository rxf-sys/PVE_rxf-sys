...
| geplant | CT 104 als reiner Immich-Container neu aufsetzen (VMID und .205 wiederverwenden, damit `photos.rxf-sys.de` ohne Cloudflare-Änderung zurückkommt) — [Anleitung](lxc/CT104-immich.md) |
